...
class Module02 extends KoanSuite with Matchers with SeveredStackTraces {
  ...
  ignore ("Can create an empty Car of a certain type with Car.empty[TYPE]") {
  ...
  ignore ("Empty Car should store items of the right type and access them by index") {
    // Put your implementation here inside the test to prevent conflicting with other tests.
    // Then uncomment the section below to test your implementation
  ...
  ignore ("Car should be covariant in its type parameter") {
    // Put your implementation here inside the test to prevent conflicting with other tests.
    // Then uncomment the section below to test your implementation
  ...
  ignore ("Car should work as expected with an abstract trait separated out for its API") {
    // Put your implementation here inside the test to prevent conflicting with other tests.
    // Then uncomment the section below to test your implementation
  ...
  ignore ("A Dock should be able to handle all cargo of a more specific type than it is defined on") {
